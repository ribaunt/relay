...
const buttonVariantsOuter = cva("", {
  variants: {
    variant: {
      ...
      success:
        "w-full border-[1px] dark:border-[2px] border-black/10 dark:border-neutral-950 bg-gradient-to-b from-emerald-300/90 to-emerald-500 dark:from-emerald-200/70 dark:to-emerald-600 p-[1px] transition duration-300 ease-in-out ",
      secondary:
